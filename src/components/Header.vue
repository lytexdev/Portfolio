<template>
    <div class="header-logo">
        <img src="../assets/images/logo.png" alt="logo" class="logo" height="281">
        <h1>lytex</h1>
    </div>
    ...
    <nav class="header-nav">
        <ul>
            ...
            <li>
                <button @click="toggleDarkMode" class="darkmode-toggle" title="Toggle Dark Mode"
                    aria-label="Toggle Dark Mode">
                    <svg v-if="isDarkMode" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <path
                                ...
                                stroke="#b92323" stroke-width="1.5" stroke-linejoin="round"></path>
                        </g>
                    </svg>
...
const toggleDarkMode = () => {
    if (darkmodeInstance.value) {
        darkmodeInstance.value.toggle()
...
onMounted(() => {
    darkmodeInstance.value = new Darkmode(options)
    darkmodeInstance.value == false
    isDarkMode.value = darkmodeInstance.value.isDarkMode
